{
  ...
  overrides = {
    latest-polysemy-conc = {
      ...
      stm-chans = {
        version = "3.0.0.11";
        hash = "0h6vdv1243csipwi7wsysprnmip4smvx8l36fq39fqya2nm9n2j0";
        repo = "hackage.haskell.org";
      };
      tasty = {
        version = "1.5.4";
    ...
    lower-polysemy-conc = {
      ...
      stm-chans = {
        version = "2.0.0";
        hash = "0afxg1wx0jkkajwcz338hm1ql4rzrj9dkdpkcvdaw04jrzaqwmby";
        repo = "hackage.haskell.org";
      };
      string-interpolate = {
        version = "0.3.4.0";
      ...
      unagi-chan = {
        version = "0.4.1.3";
        hash = "18g21x0w4k16dywykjld414a92472yp8c6wj9aq00s3yj82f688k";
        repo = "hackage.haskell.org";
      };
      unbounded-delays = {
        version = "0.1.1.1";
    ...
    lower-polysemy-process = {
      ...
      stm-chans = {
        version = "3.0.0";
        hash = "089pcaih9sxqgzxmmsiac9q4dshlzlm16zsbg1x0myqxhx7nvhb1";
        repo = "hackage.haskell.org";
      };
      tasty = {
        version = "1.2.2";
      ...
      typed-process = {
        version = "0.2.4.1";
        hash = "1mh5y2rng2igmn97wkhk2hd43am6q3gcpvb14c11bfsi685l05x5";
        repo = "hackage.haskell.org";
      };
      unagi-chan = {
        version = "0.4.1.4";
